"""
CPU and memory parameter handlers for VM configuration.

This module provides parameter handlers for CPU and memory configuration,
including validation of resource constraints, hot-add/remove capabilities,
and power cycle requirements. These handlers manage the computational
resources of virtual machines.

Both handlers support hot-add/remove operations when the VM is powered on,
