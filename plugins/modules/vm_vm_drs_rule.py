...
from ansible_collections.vmware.vmware.plugins.module_utils.vmware import (
    PyVmomi, vmware_argument_spec, wait_for_task, find_vm_by_id)
...
class VmwareDrs(PyVmomi):
    def __init__(self, module):
        ...
        self.cluster_obj = self.find_cluster_by_name(cluster_name=self.cluster_name)
